...
1. Activate plugin
1. Install your taxonomy templates in theme folder. Denoted by 'Taxonomy Template Name:' in comments at top of php file.
1. Visit Edit Category/Tag/Taxonomy to select desired template from drop menu.